    ...
    <div className="flex h-screen bg-[#F8FAFC] font-sans overflow-hidden">
      ...
      <aside className="w-[260px] bg-[#0F172A] text-white flex flex-col flex-shrink-0 shadow-xl z-20">
        ...
        <nav className="flex-1 px-4 space-y-1.5 overflow-y-auto overflow-x-hidden no-scrollbar">
          <NavItem icon={<LayoutGrid className="w-[18px] h-[18px]" />} label="Dashboard" active />
          <NavItem icon={<Building2 className="w-[18px] h-[18px]" />} label="Branches" hasDropdown />
          <NavItem icon={<Package className="w-[18px] h-[18px]" />} label="Inventory" hasDropdown />
          <NavItem icon={<Users className="w-[18px] h-[18px]" />} label="Customers" hasDropdown />
          <NavItem icon={<User className="w-[18px] h-[18px]" />} label="Employees" hasDropdown />
          <NavItem icon={<DollarSign className="w-[18px] h-[18px]" />} label="Finance" hasDropdown />
          <NavItem icon={<FileText className="w-[18px] h-[18px]" />} label="Reports" hasDropdown />
          <NavItem icon={<CreditCard className="w-[18px] h-[18px]" />} label="Expenses" hasDropdown />
        </nav>

        <div className="p-4 mt-auto mb-2">
          <button className="flex items-center gap-3 px-4 py-3 w-full text-slate-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
...
function NavItem({ icon, label, active = false, hasDropdown = false }: { icon: React.ReactNode, label: string, active?: boolean, hasDropdown?: boolean }) {
  return (
    <button 
