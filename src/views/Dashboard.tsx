  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <StatCard title="Total Revenue" value={`$${stats.revenue.toLocaleString()}`} trend="18.2%" isUp={true} delay={0.1} />
        <StatCard title="Net Profit" value={`$${stats.profit.toLocaleString()}`} trend="22.4%" isUp={true} delay={0.2} />
        <StatCard title="Operating Costs" value={`$${stats.costs.toLocaleString()}`} trend="4.1%" isUp={false} delay={0.3} />
        <StatCard title="Active Customers" value={`${stats.customers.toLocaleString()}`} trend="12.5%" isUp={true} delay={0.4} />
      </div>
